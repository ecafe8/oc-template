...
// 千分位分隔符
export const applyThousandSeparator = (value: string, thousandSeparator: boolean | string = ","): string => {
...
export function roundUpToNDecimalPlaces(value: number, decimals: number): number {
...
// 计算 bytes 转换为 KB, MB, GB 等单位的字符串表示
